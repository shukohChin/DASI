...
In this report I will explore the association between age and people's attitude towards the money we are spending on the Space exploration program.  
...
The Dataset I use is from General Social Survey(GSS). It is a sociological survey used to collect data on demographic characteristics and attitudes of residents of the United States. According to [GSS Offical Site]( http://publicdata.norc.org:41000/gssbeta/faqs.html#10), the way of data collection was listed below.
